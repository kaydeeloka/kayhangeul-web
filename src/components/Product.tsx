      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="bg-hanji-cream rounded-4xl border border-deep-pink/40 p-10 md:p-14 flex flex-col lg:flex-row gap-12 shadow-[0_8px_40px_rgba(248,177,186,0.25)]">
          ...
          <div className="relative lg:w-[40%] shrink-0 min-h-70">
            <div className="hidden absolute -top-5 -left-5 bg-korean-red text-white px-5 py-3 rounded-2xl font-black text-base z-10 shadow-md">
              50% OFF
            </div>
          ...
          <div className="lg:w-[60%] flex flex-col justify-between gap-5 py-1">
            ...
            <div className="space-y-4">
              <div className="flex items-baseline gap-3">
                <span className="hidden font-sans text-3xl font-black text-korean-red">RM 15.90</span>
                <span className="font-sans text-3xl font-black text-korean-red">RM 24.90</span>
              </div>
              <Link
